...
//		return result;  //用于测试最大值
    ...
    //intArray to String
    //need to write function by ourselves
    //String.valueOf(intArray)---->I@...
    //Arrays.toString(intArray)---->[1,1,1]
    ...
    //变为相反数
    public int[] reversePlusOne(int[] src)
    {
    ...
    public boolean isMaxExpo(int[] expo)
    {
    ...
    public boolean isEqual(int[] src, int[] dest)
    {
        int len = src.length;
        for(int i = 0; i < len; ++i)
        {
