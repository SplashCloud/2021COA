...
public class Disk {
    ...
    public int get_track_num(){return TRACK_NUM;}
    ...
    private static class DiskHead {
        ...
        public void seek(int start) {
            // TODO
            int B_in_disk_head =
                    start % (DISK_SIZE_B / DISK_HEAD_NUM);
            track =
                    B_in_disk_head / (DISK_SIZE_B / DISK_HEAD_NUM / TRACK_NUM);
            int B_in_track =
                    B_in_disk_head % (DISK_SIZE_B / DISK_HEAD_NUM / TRACK_NUM);
            sector =
                    B_in_track / (DISK_SIZE_B / DISK_HEAD_NUM / TRACK_NUM / SECTOR_PER_TRACK);
            int B_in_sector =
                    B_in_track % (DISK_SIZE_B / DISK_HEAD_NUM / TRACK_NUM / SECTOR_PER_TRACK);
            point =
                    B_in_sector / (DISK_SIZE_B / DISK_HEAD_NUM / TRACK_NUM / SECTOR_PER_TRACK / BYTE_PER_SECTOR);
        }
