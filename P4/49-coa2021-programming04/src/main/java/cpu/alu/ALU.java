...
public class ALU {
    ...
    public String negated(String src)
    {
        StringBuffer src_buff = new StringBuffer(src);
        src_buff.replace(0,1, src.charAt(0) == '0' ? "1" : "0");
        return src_buff.toString();
    }

    public static void main(String[] args) {
        ALU alu = new ALU();
        Transformer tf = new Transformer();
        System.out.println(tf.binaryToFloat(alu.adder(tf.floatToBinary("1.25"),tf.floatToBinary("2.5"),'0',32)));
    }
