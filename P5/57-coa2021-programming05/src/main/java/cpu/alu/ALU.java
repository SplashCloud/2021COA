...
public class ALU {
    ...
    public int[] addIntArray(int[] src, int[] dest)
    {
     ...
     */
    public boolean isZero(String operand) {
    ...
    public static void main(String[] args)
    {
        ...
        System.out.println(alu.mul(new DataType(tf.floatToBinary("0.5")),new DataType(tf.floatToBinary("0.4375"))));
    }
